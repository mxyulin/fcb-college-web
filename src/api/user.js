...
export const registerGuest = (form, oauthId) => request({
  url: '/api/fcb-user/register-guest',
  method: 'post',
  params: {
...
export const getButtons = () => request({
  url: '/api/fcb-system/menu/buttons',
  method: 'get'
});

export const getCaptcha = () => request({
  url: '/api/fcb-auth/oauth/captcha',
  method: 'get',
  authorization: false
});

export const logout = () => request({
  url: '/api/fcb-auth/oauth/logout',
  method: 'get',
  authorization: false
});

export const getUserInfo = () => request({
  url: '/api/fcb-auth/oauth/user-info',
  method: 'get'
});
...
export const clearCache = () => request({
  url: '/api/fcb-auth/oauth/clear-cache',
  method: 'get',
  authorization: false
});
