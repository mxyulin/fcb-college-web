    ...
    <div class="avue-crud">
        ...
        <el-form :inline="true" :size="option.size" :model="query">
          <template>
            <el-form-item label="字段">
              <el-input v-model="query.tenantId" placeholder="请输入ID"></el-input>
            </el-form-item>
            <el-form-item label="字段">
              <el-input v-model="query.member" placeholder="请输入等级"></el-input>
            </el-form-item>
            <el-form-item label="字段">
              <el-input v-model="query.state" placeholder="请输入状态"></el-input>
            </el-form-item>
            <el-form-item label="字段">
              <el-input v-model="query.createTime" placeholder="请输入创建时间"></el-input>
            </el-form-item>
            <el-form-item label="字段">
              <el-input v-model="query.updateTime" placeholder="请输入结束时间"></el-input>
            </el-form-item>
          </template>
          <!-- 查询按钮 -->
          <el-form-item>
      ...
      <el-dialog :title="title" :visible.sync="box" width="50%" :before-close="beforeClose" append-to-body>
        <el-form :disabled="view" :size="option.size" ref="form" :model="form" label-width="80px">
          <!-- 表单字段 -->
          <el-form-item label="ID" prop="tenantId">
            <el-input v-model="form.tenantId" placeholder="请输入ID"/>
          </el-form-item>
          <el-form-item label="分销商名称" prop="name">
            <el-input v-model="form.name" placeholder="请输入分销商名称"/>
          </el-form-item>
          <el-form-item label="等级" prop="member">
            <el-input v-model="form.member" placeholder="请输入等级"/>
          </el-form-item>
          <el-form-item label="电话" prop="phone">
            <el-input v-model="form.phone" placeholder="请输入电话"/>
          </el-form-item>
          <el-form-item label="累计金额" prop="totalconsumption">
            <el-input v-model="form.totalconsumption" placeholder="请输入累计金额"/>
          </el-form-item>
          <el-form-item label="消费金额" prop="currentconsumption">
            <el-input v-model="form.currentconsumption" placeholder="请输入消费金额"/>
          </el-form-item>
          <el-form-item label="业绩" prop="achievement">
            <el-input v-model="form.achievement" placeholder="请输入业绩"/>
          </el-form-item>
          <el-form-item label="上级分销商" prop="topdistributor">
            <el-input v-model="form.topdistributor" placeholder="请输入上级分销商"/>
          </el-form-item>
          <el-form-item label="一级用户" prop="oneuser">
            <el-input v-model="form.oneuser" placeholder="请输入一级用户"/>
          </el-form-item>
          <el-form-item label="一级分销商" prop="onedistributor">
            <el-input v-model="form.onedistributor" placeholder="请输入一级分销商"/>
          </el-form-item>
          <el-form-item label="创建时间" prop="time">
            <el-date-picker v-model="form.time" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择创建时间"></el-date-picker>
          </el-form-item>
