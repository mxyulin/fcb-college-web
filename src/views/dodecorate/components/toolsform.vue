  ...
  <div class="decorate-right" v-if="centerSelect!=null">
      ...
      <div v-if="templateForm.type=='banner'" class="decorate-right-write">
          ...
          <draggable :list="templateForm.content.list" v-bind="$attrs" :options="{animation:100}"
              ...
              <div class="select-style-item" v-for="(item, index) in templateForm.content.list" :key="index">
              ...
              <el-row class="title-block-body">
                  ...
                  <div v-else>
                      <div v-if="!templateForm.content.image">
                          <div v-for="(it,idx) in titleBlock.data" class="compotent-title-block-container" :key="idx"
      ...
      <div v-if="templateForm.type=='popup'" class="decorate-right-write">
          <draggable :list="templateForm.content.list" v-bind="$attrs" :options="{animation:100}">
              <div class="select-style-item select-style-block"
                  v-for="(item, index) in templateForm.content.list" :key="index">
                  <el-row class="select-style-item-title">
                      <el-col :xs="12" :sm="12">
                          <div class="select-style-item-tip">
                              弹窗设置{{index+1}}
...
export default {
  /*
   * 父组件传来的数据 centerSelect templateForm
   * 父组件绑定的事件
   */
  name: "ToolsForm",
  comments: {
