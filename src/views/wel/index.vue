        ...
        <basic-container>
          <el-collapse v-model="activeNames" @change="handleChange">
            ...
            <el-collapse-item title="拥有的核心功能" name="4">
              <div>1.前后端分离-采用前后端分离模式，前端提供两套架构，Sword基于React，Fcb基于Vue</div>
        ...
        <el-row>
          <basic-container>
            <div class="el-font-size">
              ...
              <span>官网地址</span>
              <el-divider direction="vertical"/>
              <span><el-link href="https://fcbx.vip" target="_blank"
                             type="primary">https://fcbx.vip</el-link></span>
              <el-divider content-position="right"><i class="el-icon-star-off"/></el-divider>
              <span>社区地址</span>
              <el-divider direction="vertical"/>
              <span><el-link href="https://sns.fcbx.vip" target="_blank"
                             type="primary">https://sns.fcbx.vip</el-link></span>
              <el-divider content-position="right"><i class="el-icon-star-off"/></el-divider>
              <span>获取文档</span>
              <el-divider direction="vertical"/>
              <span class="tag-group">
                <el-tag type="success" style="cursor: pointer"
                        onclick="window.open('https://sns.fcbx.vip/note/view/1.html')">免费版</el-tag>
                <el-divider direction="vertical"/>
          ...
          <basic-container>
            <el-collapse v-model="logActiveNames" @change="handleChange">
              <el-collapse-item title="3.0.1.RELEASE发布，代码生成功能全面升级" name="28">
                ...
                <div>3.[新增]Fcb风格的单表生成模版</div>
                <div>4.[新增]Fcb风格的主子表生成模版</div>
                <div>5.[新增]Fcb风格的树表生成模版</div>
              ...
              <el-collapse-item title="2.7.2.RELEASE发布，重构升级常用功能，优化使用体验" name="21">
                ...
                <div>7.[重构]Swagger聚合网关迁移至全新的fcb-swagger服务</div>
              ...
              <el-collapse-item title="2.7.1.RELEASE发布，重构钉钉监控通知，升级依赖适配最新API" name="20">
                ...
                <div>15.[重构]fcb-admin，钉钉监控通知实现</div>
                <div>16.[优化]fcb-admin，增加账号密码登录</div>
              ...
              <el-collapse-item title="2.3.0.RELEASE发布，租户增强，底层架构插件全面增强" name="12">
                ...
                <div>2.[新增]fcb升级至avue2.3.7版本</div>
                <div>3.[新增]fcb树表懒加载模式</div>
              ...
              <el-collapse-item title="2.2.0.RELEASE发布，增加集群监控，链路追踪" name="9">
                ...
                <div>6.[新增]fcb代码模板增加刷新事件</div>
                <div>7.[新增]fcb底层架构升级</div>
                <div>8.[新增]fcb支持tab切换保存页面状态</div>
                <div>9.[新增]添加bom统一版本配置</div>
                <div>10.[新增]添加trace starter</div>
                <div>11.[新增]fcb-admin排除seata服务</div>
              ...
              <el-collapse-item title="2.1.0.RELEASE发布，全面增强底层驱动" name="8">
                ...
                <div>3.[新增]fcb-admin增加nacos动态监听</div>
              ...
              <el-collapse-item title="2.0.6.RELEASE发布，兼容三大主流数据库" name="6">
                ...
                <div>10.[新增]fcb表格自适应、增加loading</div>
                <div>11.[新增]fcb通知公告模块增加富文本编辑器</div>
              </el-collapse-item>
              ...
              <el-collapse-item title="2.0.3.RELEASE发布，优化多租户oss系统，优化业务架构" name="3">
                ...
                <div>2.[优化]修正fcb_menu代码生成模块删除api的地址</div>
              ...
              <el-collapse-item title="2.0.0.RELEASE发布，完美定制的微服务开发平台" name="0">
                ...
                <div>11.[优化]fcb代码生成模板</div>
                <div>12.[新增]fcb更新至element-ui 2.8.2版本</div>
                <div>13.[修复]fcb分页bug</div>
