<template>
  ...
  <draggable
    ...
    @update="onTemplateListSortChange"
  >
    <transition-group>
      <template v-if="templateData && templateData.length > 0">
        <div
          ...
          @click.stop="selectDecorateComponent(index)"
          :key="index"
        >
          ...
          <div class="compotent-item-container">
            ...
            <div
              ...
              :style="{
                background:
                  centerSelect == 0 ? 'rgba(238,238,238,1)' : '#f6f6f6',
              }"
            >
              <!-- 悬浮的标题和搜索 -->
              <div
              ...
              >
                <el-carousel-item
                  v-for="(it, calindex) in Math.ceil(
                    compotent.content.list.length /
                      (compotent.content.style * 2)
                  )"
                  :key="calindex"
                >
                  <div class="menu-box">
                  ...
                  <template v-for="(it, index) in compotent.content.timeData">
                    ...
                    >
                      ...
                      <div class="compotent-activity-item-message">
                        <div
                          class="compotent-activity-item-title ellipsis-item"
                        >
                          {{ it.title }}
                        </div>
                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        :class="
                          it.activityType && it.activityType.includes('seckill')
                      ...
                      >
                        ...
                        <div class="compotent-goods-list-1-message">
                          <div
                            class="compotent-goods-list-1-title ellipsis-item"
                          >
                            <div
                              v-if="
                                it.activityType &&
            ...
            >
              <i
                ...
                @click.stop="removeDecorateComponent(index)"
              ></i>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    removeDecorateComponent(idx) {
      this.$emit("removeDecorateComponent", idx);
    },
    selectDecorateComponent(idx) {
      this.$emit("update:centerSelect", idx);
      this.$emit("selectDecorateComponent", idx);
    },
    onTemplateListSortChange() {
      this.$emit("onTemplateListSortChange");
    },
  },
};
</script>
