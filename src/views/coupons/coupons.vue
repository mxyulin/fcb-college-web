        ...
        <el-form :disabled="view" :size="option.size" ref="form" :model="form" label-width="80px">
          ...
          <el-form-item label="类型:cash=代金券,discount=折扣券" prop="type">
              <el-radio-group v-model="form.type">
                <el-radio v-for="(item,index) in typeData" :key="index" :label="item.dictKey">
                 {{item.dictValue}}
                </el-radio>
              </el-radio-group>
          </el-form-item>
...
<script>
  import {getList, getDetail, add, update, remove} from "@/api/coupons/coupons";
  import option from "@/const/coupons/coupons";
