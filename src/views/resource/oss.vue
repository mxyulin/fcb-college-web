  ...
  export default {
          ...
          column: [
            {
              ...
              searchLabelWidth: 50,
              row: true,
              dicUrl: "/api/fcb-system/dict/dictionary?code=oss",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
        ...
        debugOption: {
          ...
          column: [
            ...
            },
            {
              ...
              dataType: 'string',
              action: '/api/fcb-resource/oss/endpoint/put-file',
              propsHttp: {
                res: 'data',
                url: 'link',
              },
    ...
    watch: {
      ...
      'debugForm.code'() {
        ...
        column.action = `/api/fcb-resource/oss/endpoint/put-file?code=${this.debugForm.code}`;
      }
    },
    computed: {
