        ...
        regionOption: {
          ...
          column: [
            ...
            },
            {
              ...
              prop: "regionLevel",
              type: "radio",
              dicUrl: "/api/fcb-system/dict/dictionary?code=region",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
          ...
          column: [
            {
              ...
              action: "/api/fcb-system/region/import-region"
            },
            {
              label: "数据覆盖",
              prop: "isCovered",
          ...
          column: [
            {
              ...
              cascader: ['city'],
              dicUrl: '/api/fcb-system/region/select',
              span: 24,
            },
            {
              label: '地市',
              ...
              cascader: ['district'],
              dicFlag: false,
              dicUrl: '/api/fcb-system/region/select?code={{province}}',
              span: 24,
            },
            {
              label: '区县',
              ...
              dicFlag: false,
              dicUrl: '/api/fcb-system/region/select?code={{city}}',
              span: 24,
            }
          ]
        }
    ...
    watch: {
      ...
      'excelForm.isCovered'() {
        if (this.excelForm.isCovered !== '') {
          ...
          column.action = `/api/fcb-system/region/import-region?isCovered=${this.excelForm.isCovered}`;
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      handleExport() {
        this.$confirm("是否导出行政区划数据?", "提示", {
          ...
          NProgress.start();
          exportBlob(`/api/fcb-system/region/export-region?${this.website.tokenHeader}=${getToken()}`).then(res => {
      ...
      handleTemplate() {
        exportBlob(`/api/fcb-system/region/export-template?${this.website.tokenHeader}=${getToken()}`).then(res => {
