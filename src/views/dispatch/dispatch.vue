...
<script>
  import {getList, getDetail, add, update, remove} from "@/api/dispatch/dispatch";
  import option from "@/const/dispatch/dispatch";
    ...
    computed: {
      ...
      permissionList() {
        return {
          ...
          viewBtn: this.vaildData(this.permission.dispatch_view, false),
